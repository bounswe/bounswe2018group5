...
urlpatterns = [
    ...
    url(r'^get/all', views.get_all_projects, name="get_all_projects"),
    url(r'^get/(?P<ids>[a-z0-9,]*)/$', views.get_projects, name="get_projects"),
    url(r'^get/own', views.get_own_projects, name="get_own_projects"),
    ...
    url(r'^get/bids/(?P<project_id>[a-z0-9]+)/$', views.get_bids, name="get_bids"),
]
